...
void KEYPAD_voidInit()
{
	...
	DIO_voidSetPinValue(DIO_U8_PORTB,KEYPAD_U8_COLUMN_1 ,DIO_U8_HIGH );
	DIO_voidSetPinValue(DIO_U8_PORTB,KEYPAD_U8_COLUMN_2 ,DIO_U8_HIGH );
	DIO_voidSetPinValue(DIO_U8_PORTB,KEYPAD_U8_COLUMN_3 ,DIO_U8_HIGH );
